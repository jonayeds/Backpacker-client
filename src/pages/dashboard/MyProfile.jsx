...
const MyProfile = () => {
  ...
  const handleUpdate = e =>{
	...
	fetch(`http://localhost:5000/users/guide/update/${user?.email}`, {
		...
		body: JSON.stringify({phone, experience, education})
	})
	.then(res=>res.json())
	.then(data=>{
		console.log(data)
  ...
  return (
    <div className="mt-12 w-full flex items-center flex-col">
        ...
        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
          ...
          <div className="flex justify-center pt-2 space-x-4 align-center">
            <a
              ...
              href="#"
              aria-label="GitHub"
              className="p-2 rounded-md dark:text-gray-800 hover:text-[#23575C]"
            >
              <svg
                viewBox="0 0 496 512"
      ...
      {role === "guide" && (
        <div>
          <form onSubmit={handleUpdate} className="space-y-8 p-12  border-[1px] border-opacity-30 rounded-3xl mt-10  border-gray-500 max-w-md w-full">
            ...
            >
              ...
              <span className="relative mx-auto">Update</span>
            </button>
          </form>
        </div>
      )}
